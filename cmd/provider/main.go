// SPDX-FileCopyrightText: 2023 The IaC Platform Team
//
// SPDX-License-Identifier: Apache-2.0

// Package main contains the main entry point for the Crossplane provider
package main
...
func main() {
	...
	logr.Debug("Starting", "sync-period", syncInterval.String(), "poll-interval", pollInterval.String(), "max-reconcile-rate", maxReconcileRate)
