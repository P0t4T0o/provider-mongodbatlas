...
const (
	...
	commonConfigPackagePath = "github.com/crossplane-contrib/provider-mongodb-atlas/config/common"
...
const (
	...
	APISPackagePath = "github.com/crossplane-contrib/provider-mongodb-atlas/apis"
)
